...
4. Bug/Defect Log (for each issue found)
...
**Git Repository URL:** `https://github.com/mangeshganeshjoshi/AgenticAIQAE2E_WORKFLOW.git`
...
## 🔄 Complete End-to-End Prompt (Single Run)
...
Use the Girhub MCP agent to commit all new files with a descriptive message and push to the repository. 
