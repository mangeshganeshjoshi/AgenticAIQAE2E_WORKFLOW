...
test.describe('Checkout Information Entry Tests', () => {
  test('Submit form with empty Zip/Postal Code', async ({ page }) => {
    ...
    // 2. Enter First Name: 'Alice', enter Last Name: 'Smith', leave Zip/Postal Code empty
    await page.locator('[data-test=firstName]').fill('Alice');
    await page.locator('[data-test=lastName]').fill('Smith');
    
    // Verify First Name and Last Name have values, Zip is empty
    ...
    // Verify error message appears: 'Error: Postal Code is required'
